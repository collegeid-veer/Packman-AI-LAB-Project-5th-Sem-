...
class Q5PartialCreditQuestion(Question):
...
class HackedNumberPassedQuestion(Question):
    """Grade is the number of test cases passed."""
    ...
    def execute(self, grades):
        ...
        if testsFailed:
            ...
            grades.addPoints(((totaltests - testsFailed)/totaltests)*Question.getMaxPoints(self))
            #grades.assignFullCredit()
